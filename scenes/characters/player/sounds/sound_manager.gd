...
var ground_dash: SoundData  = load("res://scenes/characters/player/sounds/data/dash/on_ground.tres")
var coyote_dash: SoundData  = load("res://scenes/characters/player/sounds/data/dash/coyote.tres")
var mid_air_dash: SoundData = load("res://scenes/characters/player/sounds/data/dash/mid_air.tres")
var wall_dash: SoundData    = load("res://scenes/characters/player/sounds/data/dash/on_wall.tres")

var ground_jump: SoundData = load("res://scenes/characters/player/sounds/data/jump/on_ground.tres")
var coyote_jump: SoundData = load("res://scenes/characters/player/sounds/data/jump/coyote.tres")
var mid_air_jump: SoundData = load("res://scenes/characters/player/sounds/data/jump/mid_air.tres")
var wall_jump: SoundData   = load("res://scenes/characters/player/sounds/data/jump/on_wall.tres")
